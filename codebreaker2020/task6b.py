...
for i in range(0,len(X),17):
    ...
    print("\rProcessed %d / %d symbols in file." % (count, Xlen), ends="")
H = []
G = []
...
with open ("output.avi","wb") as F:
    ...
    for D in codewords:
        #errpr syndrome is tha parity check matrice dot input mod 2
        ...
        print("\rProccessed %d codewords in file. (%d Errors)"%  (count,len(codewords),error_count),ends="")
